...
public class DiskTest {
	...
	public static void tiDoWelcome() {
		System.out.println("\n\t\tTi-Do, Welcome");
		System.out.println("--------------------------------------------");
	...
	public static void main(String[] args) {
		...
		// initialize DigitalVideoDiscs
				 ...
				 * dvd1.setCategory("Animation"); dvd1.setCost(19.95f);
				 * dvd1.setDirector("Roger Allers"); dvd1.setLength(87); discs.add(dvd1);
				 * 
				 * DigitalVideoDisc dvd2 = new DigitalVideoDisc("Star Wars");
				 * dvd2.setCategory("Science Fiction"); dvd2.setCost(24.95f);
				 * dvd2.setDirector("George Lucas"); dvd2.setLength(124); discs.add(dvd2);
				 * 
				 * DigitalVideoDisc dvd3 = new DigitalVideoDisc("Aladdin");
				 * dvd3.setCategory("Animation"); dvd3.setCost(18.99f);
				 * dvd3.setDirector("John Musker"); dvd3.setLength(90); discs.add(dvd3);
				 * 
				 * DigitalVideoDisc dvd4 = new DigitalVideoDisc("Naruto");
				 * dvd4.setCategory("Anime"); dvd4.setCost(55.5f);
				 * dvd4.setDirector("Kishimoto Masashi"); dvd4.setLength(5148); discs.add(dvd4);
				 * 
				 * DigitalVideoDisc dvd5 = new DigitalVideoDisc("Dr.Stone");
				 * dvd5.setCategory("Anime"); dvd5.setCost(6.03f);
				 * dvd5.setDirector("Inagaki Riichiro"); dvd5.setLength(300); discs.add(dvd5);
				 * 
				 * DigitalVideoDisc dvd6 = new DigitalVideoDisc("OK");
				 * dvd6.setCategory("Music"); dvd6.setCost(10.01f); dvd6.setDirector("Binz");
				 * dvd6.setLength(3); discs.add(dvd6);
				 * 
				 * DigitalVideoDisc dvd7 = new DigitalVideoDisc("The Transporter");
				 * dvd7.setCategory("Action"); dvd7.setCost(14.99f);
				 * dvd7.setDirector("	Corey Yuen, Louis Leterrier"); dvd7.setLength(92);
				 * discs.add(dvd7);
				 */
			...
			case 2: {
				...
				do {
					...
					case 2: {
						...
						int lengMax = order.MAX_NUMBERS_ORDERS - order.getLength(); // The item number limit is 10
