					...
					case 2:
							...
							do {
								...
								case 2:
										...
										CompactDisc CD = new CompactDisc(title, category, director, length, cost, artirst);
								...
								if (items.size() == order.MAX_NUMBERS_ORDERS) 
									System.out.println("The item quantity has reached its limit");
								
							} while(typeItem != 0 && items.size() < order.MAX_NUMBERS_ORDERS);
							showMenu();
							break;
					case 3: 
